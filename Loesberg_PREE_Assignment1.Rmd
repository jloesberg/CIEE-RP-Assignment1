...
Reed et al. (2020) examined the demographic consequences of warming and precipitation change on perennial forb species in the Pacific Northwest. Changes in temperature decreased population growth rates of multiple species within current ranges, but not beyond current ranges, suggesting range movement is necessary for population persistance considering climate change in the PNW.
...
I don't think the results are unexpected. We know that species ranges will have to shift with novel environmental conditions, but we don't really understand the mechanisms behind it. Plants planted outside of their current range did better than in their current range isn't unexpected, and neither are the results that temperature/watering treatments only affected plants within their current ranges but not in novel ranges. 
